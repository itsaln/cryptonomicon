        ...
        <div class="flex">
          <div class="max-w-xs">
            ...
            <div class="flex bg-white shadow-md p-1 rounded-md shadow-md flex-wrap">
              <span
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer">BTC</span>
              <span
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer">DOGE</span>
              <span
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer">BCH</span>
              <span
                class="inline-flex items-center px-2 m-1 rounded-md text-xs font-medium bg-gray-300 text-gray-800 cursor-pointer">CHD</span>
            </div>
...
<script>
  export default {
    ...
    methods: {
      filteredTicker() {
        // return this.tickers.filter(ticker => ticker.name.include(this.filter))
      },
      ...
      normalizeGraph() {
        const maxValue = Math(...this.graph)
        const minValue = Math(...this.graph)
